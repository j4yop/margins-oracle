...
const SAMPLE_INVOICE_AUDIT = {
  ...
  actionableAdvice:
    'DO NOT SIGN THE CHALLAN AT CURRENT RATES. Line 1 (Amul Butter) is billed at ₹282 which exceeds consumer MRP (₹280). Demand an immediate ₹1,080 deduction or refuse delivery of lines 1 and 2.',
...
4. actionableAdvice: 1-2 punchy sentences advising the shopkeeper whether to dispute the invoice, refuse lines, or demand a credit note.
